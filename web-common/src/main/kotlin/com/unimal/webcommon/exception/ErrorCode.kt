...
enum class ErrorCode(
    ...
    LOGIN_NOT_SUPPORTED(message = "지원하지 않는 로그인입니다."),
    INVALID_TOKEN(message = "유효하지 않은 토큰입니다."),
    TOKEN_NOT_FOUND(message = "토큰이 없습니다."),
    EXPIRED_TOKEN(message = "만료된 토큰입니다."),
    SIGNATURE_TOKEN(message = "잘못된 서명입니다."),
    TOKEN_TYPE_NOT_FOUND(message = "존재하지 않는 토큰 타입입니다."),
    ALLOW_ACCESS_TOKEN_ONLY(message = "액세스 토큰만 허용됩니다."),
    AUTH_CODE_NOT_FOUND(message = "인증코드가 존재하지 않습니다."),
    TEL_NOT_FOUND(message = "휴대폰 번호가 존재하지 않습니다."),
    AUTH_CODE_NOT_MATCH(message = "인증코드가 일치하지 않습니다."),
    NICKNAME_USED(message = "이미 사용중인 닉네임입니다."),

    USER_NOT_FOUND(message = "사용자 정보를 찾을 수 없습니다."),
    ROLE_NOT_FOUND(message = "존재하지 않는 권한입니다."),
    EMAIL_NOT_FOUND(message = "존재하지 않는 이메일입니다."),
    NICKNAME_NOT_FOUND(message = "존재하지 않는 닉네임입니다."),
    PROVIDER_NOT_FOUND(message = "존재하지 않는 소셜종류입니다."),
    BOARD_NOT_FOUND(message = "게시판 정보를 찾을 수 없습니다."),
    REPLY_NOT_FOUND(message = "댓글 정보를 찾을 수 없습니다."),

    PASSWORD_NOT_MATCH(message = "비밀번호가 일치하지 않습니다."),
    EMAIL_USED(message = "이미 사용중인 이메일입니다."),
    TEL_USED(message = "이미 사용중인 전화번호입니다."),
    PASSWORD_FORMAT_INVALID(message = "비밀번호는 영문, 숫자, 특수문자를 포함한 8자 이상이어야 합니다."),
